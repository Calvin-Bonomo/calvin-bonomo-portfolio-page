<template>
  <v-app>
    ...
    <span class="bg">
      <v-main id="main">
        <v-div class="mainContainer" id="top">
          <!-- Main page container -->
          ...
          <!-- End of landing page -->
          <v-layout class="blurEffect" justify="left" id="projects"> <!-- Featured projects carousel -->
            <v-carousel hide-delimiters class="featuresCarousel">
              <v-carousel-item
              v-for="project in featuredProjects"
              :key="project.title"
              :src="project.image">
              <div class="carouselInfo" justify="center">
                <div class="carouselProjectTitle">{{ project.title }}</div>
                <div class="carouselProjectDesc">{{ project.description }}</div>
              </div>
              </v-carousel-item>
            </v-carousel>
          </v-layout> <!-- End of featured projects carousel -->
...
export default {
  data() {
    return {
      ...
      menuItems: [
        { icon: "mdi-star-four-points-outline", title: "Featured Projects", goto: "#projects" },
        { icon: "mdi-information-outline", title: "About", goto: "#about" },
        { icon: "mdi-at", title: "Contact", goto: "#contact" },
      ],
      featuredProjects: [
        { image: "https://media.sproutsocial.com/uploads/2017/02/10x-featured-social-media-image-size.png", title: "Test", description: "This is a test." }
      ]
    };
  },
  methods: {
